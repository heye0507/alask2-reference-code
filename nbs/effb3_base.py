...
class Fitter:
    ...
    def __init__(self, model, device, config):
        ...
        #self.load(f'/home/heye0507/alask2/models/{config.folder}/last-checkpoint.bin')
        #amp.load_state_dict(torch.load(f'/home/heye0507/alask2/models/{config.folder}/last-checkpoint.bin')['amp'])
...
net = get_net().cuda()
#checkpoint = torch.load(f'/home/heye0507/alask2/models/effb2_fold0/best-checkpoint-024epoch.bin')
